...
import com.airlocksoftware.holo.tabs.TabButtonGroup.OnTabButtonChangedListener;
...
public class TabButtonPager extends RelativeLayout implements ViewPager.OnPageChangeListener {
	...
	// CONSTRUCTORS
	public TabButtonPager(Context context) {
		this(context, null);
	}

	public TabButtonPager(Context context, AttributeSet attrs) {
		super(context, attrs);
	...
	private void initialTabSetup(TabButton button) {
		...
		checkedTabIndex = 0;
		visibleTabIndex = 0;
		mTabGroup.setOnTabChangedListener(tabListener);
	}
	...
	private OnTabButtonChangedListener tabListener = new OnTabButtonChangedListener() {
